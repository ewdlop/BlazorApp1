...
namespace MudBlazor.DM2BDCustom
{
    ...
    /// </summary>
    /// <seealso cref="https://github.com/MudBlazor/MudBlazor/blob/dev/src/MudBlazor/Components/Table/MudTableSortLabel.razor.cs"></seealso>/>
    ...
    public partial class MudTableSortLabel<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)] T> : MudComponentBase
    {
        ...
        protected virtual Task UpdateSortDirectionAsync(SortDirection sortDirection)
        {
            SortDirection = sortDirection;
            return new Task(()=>Context?.SetSortFunc(this)) ?? Task.CompletedTask;
        }
        ...
        /// </remarks>
        public virtual Task ToggleSortDirection()
        {
            if (!Enabled)
            {
        ...
        /// </summary>
        public virtual void SetSortDirection(SortDirection dir)
        {
            _direction = dir;
            StateHasChanged();
        }

        public virtual string GetSortIconClass()
        {
