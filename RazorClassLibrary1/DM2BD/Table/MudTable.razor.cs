...
using MudBlazor.DM2BDCustom.Exension;
...
namespace MudBlazor.DM2BDCustom
{
    ...
    public partial class MudTable<T> : MudTableBase
    {
        ...
        /// <summary>
        /// Define a table state which tracks the state of this table.
        /// </summary>
        [Parameter] public TableState TableState { get;set; }
        ...
        {
            Context.SortFieldLabel = TableState.SortLabel;
            Context.SortDirection = TableState.SortDirection;
        ...
        internal override async Task InvokeServerLoadFunc()
        {
            ...
            var state = new TableState
            {
                ...
                SortLabel = label is not null ? label.SortLabel : Context.SortFieldLabel
            };
